...
*/
       ...
       /* new Dummy().patch(MainActivity.this, new Dummy.ICallback() {
            @Override
            public void success(List<Task> tasks) {
                TasksAdapter adapter = new TasksAdapter(MainActivity.this, tasks);
                recyclerView.setAdapter(adapter);
                Toast.makeText(MainActivity.this, "message on UI", Toast.LENGTH_LONG).show();
...
*/
      ...
      /*  class DirectExecutor implements Executor {
        ...
        DirectExecutor gt = new DirectExecutor();
        gt.execute(new Runnable() {
            @Override
            public void run() {
                List<Task> taskList = DatabaseClient
                        .getInstance(getApplicationContext())
